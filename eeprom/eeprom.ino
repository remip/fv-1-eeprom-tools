...
void handleEvent(AceButton* /*button*/, uint8_t eventType,
    ...
    switch (eventType) {
      ...
      case AceButton::kEventLongPressed:
          ...
          writepreset(0, shimmerReverb, PRESETLEN);
          writepreset(1, spatialistCavern, PRESETLEN);
          writepreset(2, SpatialistModulated, PRESETLEN);
          writepreset(3, spatialistShimmer, PRESETLEN);
          writepreset(4, spatialistPitchVerb, PRESETLEN);
          writepreset(5, spatialistTouchReverb, PRESETLEN);
          writepreset(6, tripleDelay, PRESETLEN);
          writepreset(7, doubleTake, PRESETLEN);
